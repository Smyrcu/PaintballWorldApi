...
namespace PaintballWorld.Infrastructure.Migrations
{
    ...
    [Migration("20240506210551_teraz2")]
    partial class teraz2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PaintballWorld.Infrastructure.Models.Event", b =>
                {
                    ...
                    b.HasIndex("FieldScheduleId")
                        .IsUnique()
                        .HasFilter("[FieldScheduleId] IS NOT NULL");
            ...
            modelBuilder.Entity("PaintballWorld.Infrastructure.Models.Event", b =>
                {
                    ...
                    b.HasOne("PaintballWorld.Infrastructure.Models.FieldSchedule", "FieldSchedule")
                        .WithOne("Event")
                        .HasForeignKey("PaintballWorld.Infrastructure.Models.Event", "FieldScheduleId")
                        .OnDelete(DeleteBehavior.SetNull);
